...
class Run(SQLModel, table=True):
    ...
    rows_processed: Optional[int] = Field(default=None, description="Number of rows processed")
...
class Kpi(SQLModel, table=True):
    ...
    id: Optional[int] = Field(default=None, primary_key=True)
    run_id: int = Field(foreign_key="run.id", description="Reference to the run that generated this KPI")
    name: str = Field(description="Name of the KPI")
    value: float = Field(description="Calculated value of the KPI")
    unit: Optional[str] = Field(default=None, description="Unit of measurement")
    description: Optional[str] = Field(default=None, description="Description of what this KPI measures")
